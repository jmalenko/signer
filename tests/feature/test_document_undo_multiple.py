"""Feature test for multiple undo operations.
...
class TestDocumentUndoMultiple:
    """Test multiple undo operations with recorded workflow."""

    def test_undo_multiple_actions_file_structure(self) -> None:
        """Verify undo_multiple actions JSON file has correct structure."""
        actions_file = FIXTURES_DIR / "document1_undo_multiple.json"
    ...
    def test_undo_multiple_actions_include_required_types(self) -> None:
    ...
    def test_undo_multiple_workflow_has_multiple_annotations(self) -> None:
    ...
    def test_undo_multiple_workflow_has_multiple_undos(self) -> None:
    ...
    def test_undo_multiple_workflow_has_moves(self) -> None:
    ...
    def test_undo_multiple_workflow_valid_coordinates(self) -> None:
    ...
    def test_undo_multiple_workflow_object_ids_sequential(self) -> None:
    ...
    def test_undo_multiple_pixel_perfect(self, main_window, temp_dir) -> None:
        """Verify undo_multiple workflow produces expected output (pixel-perfect comparison)."""
        actions_file = FIXTURES_DIR / "document1_undo_multiple.json"
        expected_image = FIXTURES_DIR / "document1_undo_multiple" / "document1-signed.png"
        ...
        assert_images_equal_with_results(
            output_image,
            expected_image,
            test_name="document1_undo_multiple",
            save_results=True
        )
